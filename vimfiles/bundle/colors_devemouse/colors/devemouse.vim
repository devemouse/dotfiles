...
" BasedOn:	Bnadit colorcheme by A. S. Budden
...
let ColourAssignment['Normal']          = {"GUIFG": 'White',       "GUIBG":  'Grey20'}

let ColourAssignment['Cursor']          = {"GUIFG": 'red',       "GUIBG":  'yellow'}

" Comments are green
let ColourAssignment['Comment']         = {"GUIFG": 'SkyBlue',     "CTERMFG": 'darkcyan',     "TERM":   'Bold'}
...
let ColourAssignment['Constant']        = {"GUIFG": '#FFa0a0',     "CTERMFG": 'brown'}
...
let ColourAssignment['PreProc']         = {"GUIFG": 'indianred',   "CTERMFG":  '6'}
let ColourAssignment['Include']         = {"GUIFG": '#5050FF',     "GUI":     'Bold'} " preprocessor #include
let ColourAssignment['Define']          = {"GUIFG": '#5F5FFF',     "GUI":     'Bold'} " preprocessor #define
let ColourAssignment['Macro']           = {"GUIFG": '#5F5FFF',     "GUI":     'Bold'} " same as Define
let ColourAssignment['PreCondit']       = {"GUIFG": '#8888FF',     "GUI":     'Bold'} " preprocessor #if, #else, #endif, etc.

" Statements are shades of Blue
let ColourAssignment['Statement']       = {"GUIFG": 'khaki',        "CTERMFG":    '3'}
...
let ColourAssignment['Identifier']      = {"GUIFG": 'palegreen',   "CTERMFG": '6'}
...
let ColourAssignment['Type']            = {"GUIFG": 'darkkhaki',     "CTERMFG":    '2'}
...
" Special Stuff
let ColourAssignment['Special']         = {"GUIFG": 'navajowhite',         "CTERMFG":    '5'}
let ColourAssignment['SpecialChar']     = {"GUIFG": '#AA0000'}     " special character in a constant
let ColourAssignment['SpecialKey']      = {"GUIFG": 'yellowgreen', "CTERMFG": 'darkgreen'}     " special highlighting for 'listchars' etc
let ColourAssignment['NonText']         = {"GUIFG": 'LightBlue', "GUIBG": 'grey30', "CTERM": 'bold', "CTERMFG": 'darkblue'}     " special highlighting for 'listchars' etc
let ColourAssignment['MatchParen']      = {"GUI":   'Underline',   "GUIFG": "Yellow"}   " Highlighting of matching parentheses

" Errors
let ColourAssignment['Error']           = {"CTERMFG": '7',       "CTERMBG":   '1',       "CTERM":  'bold'}
...
" Folding
let ColourAssignment['Folded']          = {"GUIFG": 'gold',    "GUIBG":  'Grey30',   "CTERMFG": "darkgrey",   "CTERMBG": "NONE"}
let ColourAssignment['FoldColumn']      = {"GUIFG": 'tan',    "GUIBG":   'Grey30',   "CTERMFG": "darkgrey",   "CTERMBG": "NONE"}

" Searching
let ColourAssignment['IncSearch']       = {"GUIFG": 'slategray',   "GUIBG":  'khaki', "CTERM": 'NONE', "CTERMFG": "yellow",   "CTERMBG": "blue"}
let ColourAssignment['Search']         = {"GUIFG": 'wheat',   "GUIBG":  'peru', "CTERM": 'NONE', "CTERMFG": "grey",   "CTERMBG": "blue"}

" form devemouse sheme
let ColourAssignment['ModeMsg']         = {"GUIFG": 'goldenrod', "CTERM": 'NONE', "CTERMFG": "brown"}
let ColourAssignment['MoreMsg']         = {"GUIFG": 'SeaGreen', "CTERMFG": "darkgreen"}
let ColourAssignment['Question']        = {"GUIFG": 'springgreen', "CTERMFG": "green"}
let ColourAssignment['Visual']          = {"GUIFG": 'khaki',   "GUIBG":  'olivedrab', "GUI": 'none', "CTERM": 'reverse'}
let ColourAssignment['VisualNOS']       = {"CTERM": 'bold,underline'}
let ColourAssignment['WarningMsg']      = {"GUIFG": 'salmon', "CTERMFG": "1"}
let ColourAssignment['Directory']       = {"CTERMFG": "darkcyan"}
let ColourAssignment['ErrorMsg']        = {"CTERM": 'bold', "CTERMFG": "7",   "CTERMBG": "1"}
let ColourAssignment['WildMenu']        = {"CTERMFG": "0",   "CTERMBG": "3"}
let ColourAssignment['DiffAdd']         = {"CTERMBG": "4"}
let ColourAssignment['DiffChange']      = {"CTERMBG": "5"}
let ColourAssignment['DiffDelete']      = {"CTERM": 'bold', "CTERMFG": "4",   "CTERMBG": "6"}
let ColourAssignment['DiffText']        = {"CTERM": 'bold', "CTERMBG": "1"}
let ColourAssignment['Underlined']      = {"CTERM": 'underline', "CTERMFG": "7"}

" Popup Menu
let ColourAssignment['Pmenu']           = {"GUIFG": '#442206',     "GUIBG": '#ffff77',     "CTERMFG": "Black",   "CTERMBG": "Yellow"}

" Line Numbering
let ColourAssignment['LineNr']          = {"CTERMFG": '3'}

" Status Lines
let ColourAssignment['StatusLine']      = {"GUIFG": 'Black',       "GUIBG": '#c2bfa5', "GUI": 'none', "CTERM": 'bold,reverse'}
let ColourAssignment['StatusLineNC']    = {"GUIFG": 'grey50',      "GUIBG": '#c2bfa5', "GUI": 'none', "CTERM": 'reverse'}

" Vertical Splits
let ColourAssignment['VertSplit']       = {"GUIFG": 'Grey50',       "GUIBG": '#c2bfa5', "GUI": 'none', "CTERM": 'reverse'}

" Signs Column
let ColourAssignment['SignColumn']      = {"GUIBG": '#222222'}

" Text Titles
let ColourAssignment['Title']           = {"GUIFG": 'indianred',        "CTERMFG": "5"}
